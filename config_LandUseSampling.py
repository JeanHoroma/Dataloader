...
PATH_INPUT_RGB = '/media/DATA/DATA_LANDUSE/10.03__IMAGES__TUILES_EXTRAITES/frames'
# ground truth mask
PATH_INPUT_R = '/media/DATA/DATA_LANDUSE/10.03__IMAGES__TUILES_EXTRAITES/masks'
# DSM
...
(winW, winH) = (1024, 1024)
STEP = 768
PATH_OUTPUT = '/media/DATA/DATA_LANDUSE/10.03__IMAGES__TUILES_EXTRAITES/1024img/'
