...
folders = ['train_frames/img', 'train_masks/img', 'train_dsm/img', 'train_osm/img',
           'val_frames/img', 'val_masks/img', 'val_dsm/img', 'val_osm/img',
           'test_frames/img', 'test_masks/img', 'test_dsm/img', 'test_osm/img',
           'frames', 'dsm', 'masks', 'osm', 'generated/dsm', 'generated/osm', 'generated/masks', 'generated/frames',
            'generated/output/dsm', 'generated/output/osm', 'generated/output/masks', 'generated/output/frames']
...
for i in range(len(n)):
    ...
    for (x, y, resultat_r) in ReadDatFile.sliding_windowBW(np.asarray(gt), cfg.STEP, (cfg.winW, cfg.winH)):
        ...
        img_save = Image.fromarray(resultat_r)
...
# DSM images
train_dsm = all_dsm[:train_split]
val_dsm = all_dsm[train_split:val_split]
test_dsm = all_dsm[val_split:]
# OSM images
train_osm = all_osm[:train_split]
val_osm = all_osm[train_split:val_split]
test_osm = all_osm[val_split:]
...
PATH_INPUT_RGB = '/media/DATA/DATA_LANDUSE/10.03__IMAGES__TUILES_EXTRAITES/1024img/frames'
# ground truth mask
PATH_INPUT_R = '/media/DATA/DATA_LANDUSE/10.03__IMAGES__TUILES_EXTRAITES/1024img/masks'
# DSM
PATH_INPUT_DSM = '/media/DATA/DATA_LANDUSE/10.03__IMAGES__TUILES_EXTRAITES/1024img/dsm'
# OSM
PATH_INPUT_OSM = '/media/DATA/DATA_LANDUSE/10.03__IMAGES__TUILES_EXTRAITES/1024img/osm'

PATH_OUTPUT = '/media/DATA/DATA_LANDUSE/10.03__IMAGES__TUILES_EXTRAITES/1024img/generated/'
PATH_OUTPUT_MASK = '/media/DATA/DATA_LANDUSE/10.03__IMAGES__TUILES_EXTRAITES/1024img/masks/'
PATH_OUTPUT_IMAGE = '/media/DATA/DATA_LANDUSE/10.03__IMAGES__TUILES_EXTRAITES/1024img/frames/'
...
n = os.listdir(PATH_INPUT_RGB)  # List of testing images
m = os.listdir(PATH_INPUT_R)  # List of testing mask
o = os.listdir(PATH_INPUT_DSM)  # List of testing DSM
p = os.listdir(PATH_INPUT_OSM)  # List of testing OSM
...
def rot(list_frames, list_mask, list_dsm, list_osm, count):
